...
* tradeItemName 1..* BackboneElement "The name of the product"
...
* associatedGenericProduct 0..* BackboneElement "Association(s) between a product and referenced products. Such relationships could be for packaging, representing duplicates/semantic equivalencies between Products, etc"
...
* contains 0..* BackboneElement "Content of the trade item"
  * tradeItem 1..1 Reference(TradeItem) "Content of the trade item"
  * quantity 1..1 Quantity "how many units of use of the referenced trade item product are in this trade item"
